...
public interface KindaRebalancedCombatLevelsConfig extends Config {
    ...
    @ConfigItem(
            keyName = "changePlayerCombatLevel",
            name = "Rebalance Combat level of player",
            description = "Makes it so your combat level also becomes the average between your combat skills (excluding prayer and HP), making the max combat level 99."
    )
    default boolean changePlayerCombatLevel() {
        return true;
    }
}
